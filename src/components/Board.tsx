              ...
              {!tile.dropped ? (
                <div
                  ...
                  style={{
                    ...
                    zIndex: (tile as any).moving ?? tile.index * 10000 + tile.row * 100 + tile.index,
                    filter: `grayscale(${tile.exposed ? '0' : '100%'})`,
                    '--tile-transform': !tile.onBuffer
                      ? `translate(${50 * (tile.column - 1)}%, ${50 * (tile.row - 1)}%)`
                      : `translate(${50 * (tile.column - 1)}%, ${(rows.value / 2 + 2) * 100}%)`
                  }}
                ...
                >
                  <Tile
                    ...
                    lineColor={tile.selected ? variants.latte.red.hex : undefined}
                    class={['transition', 'duration-100', 'h-100/80', 'w-100/80', styles['tile-svg']]}
                  ></Tile>
                </div>
              ) : null}
            </Transition>
